...
public class Grapple : MonoBehaviour
{
    ...
    //         }
    //     }
    //     swagg = GetComponent<Swagg>();
    //     rigid = GetComponent<Rigidbody>();
    //     anim = GetComponent<Animator>();
    //     swaggColld = GetComponent<Collider>();
    ...
    // void StartGrapple()
    // {
    //     facing = swagg.GetFacing();
    //     swagg.enabled = false;
    //     anim.CrossFade("Swagg_Attack_" + facing, 0);
    //     swaggColld.enabled = false;
